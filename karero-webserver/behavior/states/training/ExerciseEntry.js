...
export class ExerciseEntry extends StateWrap{
    constructor(emotionProcessor, gesturePostureProcessor, speechProcessor, brainEvents){
        ...
        super("exerciseEntry", emotionProcessor, gesturePostureProcessor, speechProcessor, brainEvents);
        ...
        this.utterances = [
            "Hallo! Toll, dass du hier bist. Ich bin Zenieth, dein persönlicher Fitnesstrainer und ich möchte dich heute zu etwas Sport motivieren.",
            "Hey, schön dich zu sehen! Ich bin Zenieth, dein persönlicher Fitnesstrainer. Ich würde dich heute gerne für etwas sportliche Aktivität begeistern.",
            "Guten Tag! Toll, dass du vorbeischaust. Ich bin Zenieth dein persönlicher Fitnesstrainer. Heute können wir gemeinsam ein kleines Workout machen."
        ];
