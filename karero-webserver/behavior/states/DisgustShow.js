...
export class DisgustShow extends StateWrap{
    constructor(emotionProcessor, gesturePostureProcessor, speechProcessor, brainEvents){

        /* Call the super constructor and set the identification name for the state class */
        super("disgustShow", emotionProcessor, gesturePostureProcessor, speechProcessor, brainEvents);
        ...
        this.state.transitions.push(new Transition("chatBase", "chatBase", () => {
            console.log('transition action for "disgustShow" in "chatBase" state');
        }));
    }
    ...
    enterFunction(){
        ...
        this.ScreenFace.emotion.disgust();
        this.RoboticBody.disgust();
