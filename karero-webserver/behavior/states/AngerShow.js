...
export class AngerShow extends StateWrap{
    constructor(emotionProcessor, gesturePostureProcessor, speechProcessor, brainEvents){

        /* Call the super constructor and set the identification name for the state class */
        super("angerShow", emotionProcessor, gesturePostureProcessor,speechProcessor, brainEvents);
        ...
        this.state.transitions.push(new Transition("chatBase", "chatBase", () => {
            console.log('transition action for "attack" in "chatBase" state');
        }));
    }
