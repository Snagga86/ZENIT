...
export class VideoCall extends StateWrap{
    constructor(emotionProcessor, gesturePostureProcessor, speechProcessor, brainEvents){

        /* Call the super constructor and set the identification name for the state class */
        super("videoCall", emotionProcessor, gesturePostureProcessor, speechProcessor, brainEvents);
        ...
        this.state.transitions.push(new Transition("emergencyCall", "emergencyCall", () => {
        }));
