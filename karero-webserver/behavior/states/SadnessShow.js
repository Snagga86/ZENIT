...
export class SadnessShow extends StateWrap{
    constructor(emotionProcessor, gesturePostureProcessor,speechProcessor, brainEvents){

        /* Call the super constructor and set the identification name for the state class */
        super("sadnessShow", emotionProcessor, gesturePostureProcessor,speechProcessor, brainEvents);
        ...
        this.ANTICIPATED_ANIMATION_DURATION = 9000; /* Time duration in milliseconds. */
        ...
        this.state.transitions.push(new Transition("chatBase", "chatBase", () => {
            console.log('transition action for "sadnessShow" in "chatBase" state');
        }));
    }
